...
<div class="course-intro-content">
	...
	<div class="course-meta">
		<div class="course-meta__row">
			<?php if ( !empty( $course_rating_html ) ) : ?>
				<div class="course-meta__item">
					<a href="#course-section__reviews"><?php do_action( 'ldcr_course_rating', $course_id, true, true, true ); ?></a>
				</div>
			<?php endif; ?>
			<div class="course-meta__item">
		...
		<div class="course-meta__row">
			...
			<div class="course-meta__item">
				<span class="meta__updated"><i class="far fa-calendar"></i><?php printf( __( 'Mise à jour le %s', 'talemy' ), get_the_modified_date() ); ?></span>
			</div>
		</div>
		<div class="course-meta__row">
