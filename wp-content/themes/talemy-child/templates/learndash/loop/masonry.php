...
$meta = talemy_get_setting( 'masonry_meta_data' );
...
if ( $user_id ) {
	if ( $has_access && !$is_completed ) {
		...
		$badge_text = esc_html__( 'Vous êtes inscrit', 'talemy' );
	} elseif ( $has_access && $is_completed ) {
		$badge_class = 'post-badge completed';
		$badge_text = esc_html__( 'COMPLÉTÉ', 'talemy' );
	}
}
	...
	<div class="post-body">
		...
		<div class="post-info">
			...
			<div class="course-meta">
				<span class="course-meta__author"><?php printf( esc_html__( 'par %s', 'talemy' ), '<a href="'. esc_url( get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ) ) .'">' . get_the_author() . '</a>' ); ?></span>
