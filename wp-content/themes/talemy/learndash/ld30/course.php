...
<div class="<?php echo esc_attr( learndash_the_wrapper_class() ); ?>">
    ...
    if( $course_certficate_link && !empty($course_certficate_link) ):
        ...
        learndash_get_template_part( 'modules/alert.php', array(
            ...
            'icon'      =>  'certificate',
            'message'   =>  __( 'You\'ve earned a certificate!', 'talemy' ),
            'button'    =>  array(
                'url'    =>  $course_certficate_link,
                'icon'   =>  'download',
                'label'  =>  __( 'Download Certificate', 'talemy' ),
                'target' => '_new'
            )
        ), true );
...
<?php if ( empty( $sections ) ) : return; endif; ?>
    ...
    <?php foreach ( $sections as $section => $section_title ) : ?>
        ...
        <?php if ( 'overview' == $section ) : ?>
            ...
            <div class="course-section" id="course-section__overview">
                <div class="<?php echo esc_attr( learndash_the_wrapper_class() ); ?> content">
                <?php
                    /**
                     * Content tabs
                     *
                    ...
                    if( $has_course_content && $show_course_content ): ?>
                        ...
                        <div class="ld-item-list ld-lesson-list">
                            <div class="ld-section-heading">
                                ...
                                <h2><?php printf( esc_html_x( '%s Content', 'Course Content Label', 'talemy' ), esc_attr( LearnDash_Custom_Label::get_label( 'course' ) ) ); ?></h2>
                                ...
                                <div class="ld-item-list-actions" data-ld-expand-list="true">
                                    ...
                                    if( $has_topics || $has_lesson_quizzes ): ?>
                                        <div class="ld-expand-button ld-primary-background" id="<?php echo esc_attr( 'ld-expand-button-' . $course_id ); ?>" data-ld-expands="<?php echo esc_attr( 'ld-item-list-' . $course_id ); ?>" data-ld-expand-text="<?php echo esc_attr_e( 'Expand All', 'talemy' ); ?>" data-ld-collapse-text="<?php echo esc_attr_e( 'Collapse All', 'talemy' ); ?>">
                                            <span class="ld-icon-arrow-down ld-icon"></span>
                                            <span class="ld-text"><?php echo esc_html_e( 'Expand All', 'talemy' ); ?></span>
        ...
        <?php elseif ( 'reviews' == $section ) : ?>
            ...
            <div class="course-section" id="course-section__reviews"><?php do_action( 'ldcr_course_reviews' ); ?></div>
