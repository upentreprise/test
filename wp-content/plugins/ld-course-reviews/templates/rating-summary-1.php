 ...
 * 
 * This template can be overridden by copying it to yourtheme/course-reviews/rating-summary-1.php.
 *
	...
	<?php for ( $score = 5; $score > 0; $score -- ) : ?>
		...
		<div class="ldcr-stats__row<?php if ( $percentage == 0 ) { echo ' disabled'; } ?>" data-filter="<?php echo esc_attr( $score ); ?>">
			<span class="ldcr-meter">
				<a href="javascript:void(0)" class="ldcr-meter--filled" style="width:<?php echo esc_attr( $percentage ); ?>%;"></a>
			</span>
