 ...
 * Email Styles
 *
 * This template can be overridden by copying it to yourtheme/spirit/emails/email-styles.php.
 *
...
#body_content td ul.sf-item-meta {
	font-size: small;
	margin: 1em 0 0;
	padding: 0;
	list-style: none;
...
#body_content td ul.sf-item-meta li {
	margin: 0.5em 0 0;
	padding: 0;
}

#body_content td ul.sf-item-meta li p {
	margin: 0;
}
...
.button {
	background-color: <?php echo esc_attr( $button ); ?>;
	color:#fff;
	font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;
	font-size:15px;
	font-weight:bold;
