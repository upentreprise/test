...
$demo_img_email_icon = SF_Demo_Installer::add_media_image( 'https://talemy.themespirit.com/high-school/wp-content/uploads/sites/15/2019/04/newsletter_purple.png' );
...
if ( 'all' == $demo_data || in_array( 'pages', $demo_data ) ) {
	$demo_page_homepage = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/high-school/pages/home_high_school.json',
		'post_meta' => array(
	...
	$demo_page_about_us = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/high-school/pages/about_us.json',
		'post_meta' => array(
	...
	$demo_page_about_us_2 = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/high-school/pages/about_us_2.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_contact = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/high-school/pages/contact_us.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_faqs = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/high-school/pages/faqs.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_research = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/high-school/pages/research.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
...
if ( defined( 'LEARNDASH_VERSION' ) && ( 'all' == $demo_data || in_array( 'courses', $demo_data ) ) ) {
	...
	$ld_course_content = TALEMY_DEMO_DIR . 'demos/high-school/pages/course_content.json';
...
/** Revolution Slider **/
if ( 'all' == $demo_data || in_array( 'sliders', $demo_data ) ) {
	SF_Demo_Installer::import_rev_sliders( array( TALEMY_DEMO_DIR .'demos/high-school/sliders/home_high_school.zip' ) );
}
...
if ( 'all' == $demo_data || in_array( 'widgets', $demo_data ) ) {
	...
	$demo_img_logo_light = SF_Demo_Installer::add_media_image( 'https://talemy.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/09/logo_light.png' );
	$demo_img_logo_light_url = wp_get_attachment_image_src( $demo_img_logo_light, 'full' );
	...
	SF_Demo_Installer::add_widget_to_sidebar(
		...
		array(
			'title' => '',
			'logo' => $demo_img_logo_light_url[0],
			'retina_logo' => '',
			'logo_width' => 135,
			'logo_height' => 43,
			'description' => '',
	...
	$demo_img_map = SF_Demo_Installer::add_media_image( 'https://talemy.themespirit.com/high-school/wp-content/uploads/sites/15/2018/10/map.png' );
	$demo_img_map_url = wp_get_attachment_image_src( $demo_img_map, 'full' );

	SF_Demo_Installer::add_widget_to_sidebar(
		'footer-5',
		'media_image',
		array(
			'attachment_id' => $demo_img_map,
			'url' => $demo_img_map_url[0],
			'title' => '',
			'size' => 'full',
			'width' => 242,
			'height' => 157,
...
if ( 'all' == $demo_data || in_array( 'options', $demo_data ) ) {
	SF_Demo_Installer::install_theme_options( TALEMY_DEMO_DIR . 'demos/high-school/options.json' );
