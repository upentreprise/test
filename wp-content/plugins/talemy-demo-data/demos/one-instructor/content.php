...
/** Images **/
$demo_img_1 = $demo_img_2 = $demo_img_3 = $demo_img_4 = $demo_img_5 = $demo_img_6 = $demo_img_7 = $demo_img_8 = $demo_img_9 = $demo_img_10 = $demo_img_11 = $demo_img_12 =$demo_img_13 = $demo_img_14 = $demo_img_15 = $demo_img_16 = $demo_img_17 = $demo_img_18 = '';
...
$demo_img_logo = SF_Demo_Installer::add_media_image( 'https://talemy.themespirit.com/one-instructor/wp-content/uploads/sites/19/2018/09/logo_light.png' );
$theme_options['logo'] = wp_get_attachment_image_url( $demo_img_logo, 'full' );
...
if ( 'all' == $demo_data || in_array( 'pages', $demo_data ) ) {
	...
	$demo_img_logo_dark = SF_Demo_Installer::add_media_image( 'https://talemy.themespirit.com/one-instructor/wp-content/uploads/sites/19/2018/09/logo.png' );

	$demo_page_homepage = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/one-instructor/pages/home_one_instructor.json',
		'post_meta' => array(
			'_wp_page_template' => 'elementor_header_footer',
			'_sf_page_logo' => 1,
			'_sf_logo' => $demo_img_logo_dark,
			'_sf_logo_width' => 135,
			'_sf_logo_height' => 43
		)
	));
	...
	$demo_page_about_us = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/one-instructor/pages/about_us.json',
		'post_meta' => array(
	...
	$demo_page_about_us_2 = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/one-instructor/pages/about_us_2.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_contact = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/one-instructor/pages/contact_us.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_faqs = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/one-instructor/pages/faqs.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_research = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/one-instructor/pages/research.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
...
if ( defined( 'LEARNDASH_VERSION' ) && ( 'all' == $demo_data || in_array( 'courses', $demo_data ) ) ) {
	...
	$ld_course_content = TALEMY_DEMO_DIR . 'demos/one-instructor/pages/course_content.json';
...
if ( 'all' == $demo_data ) {
	$demo_main_menu_id = SF_Demo_Installer::add_menu( 'demo-main-menu', array( 'side', 'side_right' ) );
	...
	$demo_empty_menu_id = SF_Demo_Installer::add_menu( 'demo-empty-menu', array( 'main' ) );
	$theme_options['nav_menu_locations'] = array( 'main' => $demo_empty_menu_id, 'side' => $demo_main_menu_id, 'side_right' => $demo_main_menu_id, 'footer' => $demo_footer_menu_id, 'account' => $demo_account_menu_id );
...
if ( 'all' == $demo_data || in_array( 'options', $demo_data ) ) {
	SF_Demo_Installer::install_theme_options( TALEMY_DEMO_DIR . 'demos/one-instructor/options.json' );
