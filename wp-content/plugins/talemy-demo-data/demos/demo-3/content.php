...
if ( 'all' == $demo_data || in_array( 'pages', $demo_data ) ) {
	$demo_page_homepage = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-3/pages/home_demo_3.json',
		'post_meta' => array(
	...
	$demo_page_about_us = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-3/pages/about_us.json',
		'post_meta' => array(
	...
	$demo_page_about_us_2 = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-3/pages/about_us_2.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_contact = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-3/pages/contact_us.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_faqs = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-3/pages/faqs.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_research = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-3/pages/research.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
...
if ( defined( 'LEARNDASH_VERSION' ) && ( 'all' == $demo_data || in_array( 'courses', $demo_data ) ) ) {
	...
	$ld_course_content = TALEMY_DEMO_DIR . 'demos/demo-3/pages/course_content.json';
...
if ( 'all' == $demo_data || in_array( 'sliders', $demo_data ) ) {
	SF_Demo_Installer::import_rev_sliders( array( TALEMY_DEMO_DIR .'demos/demo-3/sliders/home_demo_3.zip' ) );
}
...
if ( 'all' == $demo_data ) {
	...
	SF_Demo_Installer::add_menu_item_link( $demo_main_menu_id, array(
		'parent_id' => $demo_main_menu_item_home_set_1,
		'title' => 'Demo 3',
		'url' => 'https://talemy.themespirit.com/demo-3/'
	));
...
if ( 'all' == $demo_data || in_array( 'widgets', $demo_data ) ) {
	...
	$demo_img_map = SF_Demo_Installer::add_media_image( 'https://talemy.themespirit.com/demo-3/wp-content/uploads/sites/3/2018/10/map.png' );
...
if ( 'all' == $demo_data || in_array( 'options', $demo_data ) ) {
	SF_Demo_Installer::install_theme_options( TALEMY_DEMO_DIR . 'demos/demo-3/options.json' );
