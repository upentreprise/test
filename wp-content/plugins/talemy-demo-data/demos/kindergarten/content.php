...
if ( 'all' == $demo_data || in_array( 'pages', $demo_data ) ) {
	$demo_page_homepage = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/kindergarten/pages/home_kindergarten.json',
		'post_meta' => array(
	...
	$demo_page_about_us = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/kindergarten/pages/about_us.json',
		'post_meta' => array(
	...
	$demo_page_about_us_2 = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/kindergarten/pages/about_us_2.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_contact = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/kindergarten/pages/contact_us.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_faqs = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/kindergarten/pages/faqs.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_research = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/kindergarten/pages/research.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
...
if ( defined( 'LEARNDASH_VERSION' ) && ( 'all' == $demo_data || in_array( 'courses', $demo_data ) ) ) {
	...
	$ld_course_content = TALEMY_DEMO_DIR . 'demos/kindergarten/pages/course_content.json';
...
if ( 'all' == $demo_data || in_array( 'sliders', $demo_data ) ) {
	SF_Demo_Installer::import_rev_sliders( array( TALEMY_DEMO_DIR .'demos/kindergarten/sliders/home_kindergarten.zip' ) );
}
...
if ( 'all' == $demo_data ) {
	...
	$demo_main_menu_item_home = SF_Demo_Installer::add_menu_item_link( $demo_main_menu_id, array(
		...
		'_sf_megamenu' => array(
			'icon' => 'fas fa-home',
			'item_bg_color' => '#e74c3c',
			'type' => 'mega_menu',
			'width' => '3',
			'bg_image' => 'https://talemy.themespirit.com/kindergarten/wp-content/uploads/sites/10/2019/05/menu_bg_child.png',
			'bg_repeat' => 'no-repeat',
...
if ( 'all' == $demo_data || in_array( 'options', $demo_data ) ) {
	SF_Demo_Installer::install_theme_options( TALEMY_DEMO_DIR . 'demos/kindergarten/options.json' );
