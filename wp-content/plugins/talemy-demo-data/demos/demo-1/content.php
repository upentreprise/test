...
if ( 'all' == $demo_data || in_array( 'pages', $demo_data ) ) {
	$demo_page_homepage = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-1/pages/home_demo_1.json',
		'post_meta' => array(
	...
	$demo_page_about_us = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-1/pages/about_us.json',
		'post_meta' => array(
	...
	$demo_page_about_us_2 = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-1/pages/about_us_2.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_contact = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-1/pages/contact_us.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_faqs = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-1/pages/faqs.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
	...
	$demo_page_research = SF_Demo_Installer::add_elementor_page( array(
		'file' => TALEMY_DEMO_DIR . 'demos/demo-1/pages/research.json',
		'post_meta' => array(
			'_wp_page_template' => 'page-builder.php'
		)
	));
...
if ( defined( 'MC4WP_VERSION' ) ) {
	SF_Demo_Installer::add_custom_post_type( array(
			...
			'post_content' => '<p>Well, the way they make shows is, they make one show. That show\'s called a pilot.</p>
<p>
	<input type="email" name="EMAIL" placeholder="Your email address" style="border-color:#ddd;background-color:#f6f6f6;" required />
</p>
<p>
	<input type="submit" class="btn btn-primary btn-sm" value="Sign up" style="min-width:120px" />
</p>'
	));
}
...
if ( defined( 'LEARNDASH_VERSION' ) && ( 'all' == $demo_data || in_array( 'courses', $demo_data ) ) ) {
	...
	$ld_course_content = TALEMY_DEMO_DIR . 'demos/demo-1/pages/course_content.json';
...
if ( 'all' == $demo_data || in_array( 'sliders', $demo_data ) ) {
	SF_Demo_Installer::import_rev_sliders( array( TALEMY_DEMO_DIR .'demos/demo-1/sliders/home_demo_1.zip' ) );
}
...
if ( 'all' == $demo_data ) {
	...
	$theme_options['nav_menu_locations'] = array(
		'main' => $demo_main_menu_id,
		'side' => $demo_main_menu_id,
		'footer' => $demo_footer_menu_id,
		'account' => $demo_account_menu_id
	);
...
if ( 'all' == $demo_data || in_array( 'widgets', $demo_data ) ) {
	...
	SF_Demo_Installer::add_widget_to_sidebar(
		...
		array(
			'title' => '',
			'text' => '[instagram-feed num=8 cols=8 showfollow=true]'
		)
	);
...
if ( 'all' == $demo_data || in_array( 'options', $demo_data ) ) {
	SF_Demo_Installer::install_theme_options( TALEMY_DEMO_DIR . 'demos/demo-1/options.json' );
