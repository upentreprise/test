...
`;
        ...
        let ncOnlyFields = $('[data-field=bc-uatc-pro-only]');
        // ncOnlyFields.prop('disabled', true);

        ncOnlyFields.on('mousedown', function(e){
            return;

        });

        $(".bc-uatc-color-picker").spectrum({
            color: '',
            allowEmpty: true,
            showAlpha: true,
            preferredFormat: "hex",
        ...
        $('.bc-uatc-select-image').on('click', function(){
            if ($(this).attr('data-field') === 'bc-uatc-pro-only')
            {
                return;
            }
            let col = $(this).closest('.image-container');
            let forImage = col.attr('data-image');
            frame = wp.media({
            ...
            frame.on('select', function(){
                ...
                $('#' + forImage).val(attachment.url);
                col.find('img').attr('src', attachment.url);
       ...
       $('#save-settings').on('click', function(){
           ...
           let buttonOptions = {
               ...
               variableText: $('#button-variable-text').val(),
               groupedText: $('#button-grouped-text').val(),
               externalText: $('#button-external-text').val(),
               wooBookingText: $('#button-woocommerce-booking-text').val(),
               textSize: $('#text-size').val(),
               textSizeUnit: $('#text-size-unit').val(),

               iconFontSize: $('#icon-font-size').val(),
               iconFontSizeUnit: $('#icon-font-size-unit').val(),

               icon: $('[name=button-icon]:checked').val(),
               loadingIcon: $('[name=loading-icon]:checked').val(),
               addedIcon: $('[name=added-icon]:checked').val(),
               quantityBoxStyle: $('[name=quantity-box-style]:checked').val(),
               iconPosition: $('#icon-position').val(),
               initialImage: $('#initial-image').val(),
               loadingImage: $('#loading-image').val(),
               addedImage: $('#added-image').val(),
               imagePosition: $('#image-position').val(),
               subtractImage: $('#subtract-image').val(),
               addImage: $('#add-image').val(),
               buttonWidth: $('#button-width').val(),
               buttonWidthUnit: $('#button-width-unit').val(),
               buttonHeight: $('#button-height').val(),
               buttonHeightUnit: $('#button-height-unit').val(),
               buttonBackgroundType:  $('[name=button-background-type]:checked').val(),
               buttonIconPosition:  $('[name=button-icon-position]:checked').val(),
               buttonSolidBackgroundColor: $('#button-solid-background-color').val(),
               buttonIconColor: $('#button-icon-color').val(),
               buttonSolidTextColor: $('#button-solid-text-color').val(),

               useCustomButtonSizes: $('#use_custom_button_sizes').is(":checked"),
               buttonDisplayBlock: $('#button_display_block').is(":checked"),
               useCustomBackground: $('#use_custom_background').is(":checked"),
               useCustomPadding: $('#use_custom_padding').is(":checked"),
               enableAjaxProductPage: $('#enable_ajax_add_to_cart').is(":checked"),
               useCustomMargin: $('#use_custom_margin').is(":checked"),
               useCustomBorderRadius: $('#use_custom_border_radius').is(":checked"),

               buttonSolidHoverBackgroundColor: $('#button-solid-hover-background-color').val(),
               buttonSolidHoverTextColor: $('#button-solid-hover-text-color').val(),
               buttonGradientFirstBackgroundColor: $('#button-gradient-first-background-color').val(),
               buttonGradientSecondBackgroundColor: $('#button-gradient-second-background-color').val(),
               buttonGradientHoverFirstBackgroundColor: $('#button-gradient-hover-first-background-color').val(),
               buttonGradientHoverSecondBackgroundColor: $('#button-gradient-hover-second-background-color').val(),
               
               buttonGradientDegree: $('#button-gradient-degree').val(),
               buttonGradientHoverDegree: $('#button-gradient-hover-degree').val(),

               buttonGradientTextColor: $('#button-gradient-text-color').val(),
               buttonGradientHoverTextColor: $('#button-gradient-hover-text-color').val(),

               style: $('#style').val(),
               displayAddMinus: $('#display_add_minus').is(":checked"),
               showQuantityBoxShopPage:  $('#show_quantity_box_shop_page').is(":checked"),
               useATCQuantityStyle: $('#use_atc_quantity_style').is(":checked"),
               quantityFloat: $('#quantity-float').val(),
               minusAddWidth: $('#minus-add-width').val(),
               minusAddHeight: $('#minus-add-height').val(),

               buttonMarginTop: $('#button-margin-top').val(),
               buttonMarginBottom: $('#button-margin-bottom').val(),
               buttonMarginLeft: $('#button-margin-left').val(),
               buttonMarginRight: $('#button-margin-right').val(),


               buttonBorderWidth: $('#button-border-width').val(),
               buttonBorderColor: $('#button-border-color').val(),
               buttonBorderStyle: $('#button-border-style').val(),


               buttonRadiusTopLeft: $('#button-radius-top-left').val(),
               buttonRadiusTopRight: $('#button-radius-top-right').val(),
               buttonRadiusBottomLeft: $('#button-radius-bottom-left').val(),
               buttonRadiusBottomRight: $('#button-radius-bottom-right').val(),

               buttonPaddingTop: $('#button-padding-top').val(),
               buttonPaddingBottom: $('#button-padding-bottom').val(),
               buttonPaddingLeft: $('#button-padding-left').val(),
               buttonPaddingRight: $('#button-padding-right').val(),

               buttonImageBackgroundSize: $('#button-image-background-size').val(),
               buttonImageBackgroundRepeat: $('#button-image-background-repeat').val(),
               buttonImageBackgroundURL: $('#button-image-background').val(),


               qtyBoxWidth: $('#qty-box-width').val(),
               qtyBoxHeight: $('#qty-box-height').val(),

               hideQtyInputArrows: $('#hide-qty-input-arrows').is(":checked")


           };

           $.post(ajaxurl, {
               action: 'bc_uatc_save_options',
    ...
    //
    // let buttonIconInput = $('#button-icon');
    // buttonIconInput.autocomplete({
    //     source: iconList
    // });
    //
    // buttonIconInput.on('blur', function(){
    //     console.log('changing icon');
    //     $('#icon-preview').attr('class', 'fa ' + buttonIconInput.val());
    // });

    //initiate codemirror
    // let codeBox = $('#uatc-code-box');
    ...
    if (document.getElementById('uatc-code-box') === null)
        return;
    let editor = CodeMirror.fromTextArea(document.getElementById("uatc-code-box"), options);

    editor.setSize(600, cm_height);
