...
$woobookcreateinvoice= get_option( 'woobookcreateinvoicecom' );  
...
//end of create invoice  
   ...
   $woobookcreateestimate= get_option( 'woobookcreateestimatecom' );   
...
//end of create estimate  
 ...
 $woobookcreatesalesreceipt= get_option( 'woobookcreatesalesreceiptcom' );   
...
$srcpt=  $ratul9006["code"];      
  //echo $response9;
   ...
   $woobookcreatepayment= get_option( 'woobookcreatepaymentcom' ); 
